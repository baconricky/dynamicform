...
(function(window, document, $, undefined) {
    ...
    dynamicForm.BuildOptions = function(opts) {
        ...
        var _sandbox = {
            QA_Version: "/* @echo VERSION */ SANDBOX + jQuery " + $.fn.jquery,
            elqSiteId: "711611696"
        };
        var _production = {
            QA_Version: "/* @echo VERSION */ + jQuery " + $.fn.jquery,
    ...
    dynamicForm.UI.Template = {
        ...
        Thanks: {
            GenerateHTML: function() {
                ...
                if (dynamicForm.options.no_offer || !dynamicForm.options.ShowThanksButton) {
        ...
        Offer: function(opts) {
            ...
            if (dynamicForm.options.no_offer) {
                ...
                if (!dynamicForm.Util.HasValue(offer_id) || (typeof dynamicForm.data.GetElqOffer !== 'undefined' && typeof dynamicForm.data.GetElqOffer[offer_id] === 'function')) {
                    ...
                    lookup.done(function() {
                        var i, isUpdatedOffer = (offer_id === dynamicForm.data.UpdatedOfferId);
                        if (typeof dynamicForm.data.GetElqOffer !== 'undefined') {
        ...
        Validation: function(config) {
            ...
            $("#" + dynamicForm.options.elqFormName).validate({
                ...
                rules: {
                    ...
                    "C_EmailAddress": {
                        required: $("#C_EmailAddress").is(":visible"),
                        email: true
                    },
                    "C_BusPhone": {
